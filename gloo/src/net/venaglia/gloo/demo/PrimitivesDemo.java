...
import net.venaglia.gloo.util.CallLogger;
import net.venaglia.gloo.view.KeyHandler;
import net.venaglia.gloo.view.MouseTarget;
import net.venaglia.gloo.view.MouseTargetEventListener;
...
//        view3D.setBackgroundColor(Color.GRAY_25);
            ...
            public void renderFrame(long nowMS, ProjectionBuffer buffer) {
                ...
                for (int shapeNum = 0; shapeNum < 3; shapeNum++) {
                    ...
                    if (CallLogger.logCalls) {
                        String name = objects.getShapeName(shapeNum);
                        CallLogger.logCall("shapes['" + name + "'].project", nowMS, "openGL");
                    }
...
//        new PrimitivesDemo().start(false, 30, DemoObjects.ObjectCategory.ROUND_SOLIDS);
        new PrimitivesDemo().start(false, 30, DemoObjects.ObjectCategory.TEXTURES);
    }
