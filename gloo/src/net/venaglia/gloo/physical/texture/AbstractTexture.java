...
public abstract class AbstractTexture implements Texture {
    ...
    protected void loadImpl() {
        ...
        glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, getMinFilterCode());
        if (logCalls) logCall("glTexParameteri", GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, getMinFilterCode());
