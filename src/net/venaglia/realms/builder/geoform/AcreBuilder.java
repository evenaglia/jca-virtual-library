...
import static net.venaglia.realms.builder.map.AbstractCartographicElement.ELEMENT_ORDER;
...
import net.venaglia.realms.builder.map.GeoPointBasedElement;
...
import net.venaglia.realms.common.util.Consumer;
