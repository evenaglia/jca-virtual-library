...
//        Teapot teapot = new Teapot(BezierPatch.DetailLevel.MEDIUM_HIGH).translate(centerOnOrigin);
...
//                return new Light[]{
//                        new FixedPointSourceLight(new net.venaglia.realms.common.physical.geom.Point(-2.1f, 0.0f, 1.5f).scale(cameraDistance))
//                };
//            }
//        }.start();
    }
