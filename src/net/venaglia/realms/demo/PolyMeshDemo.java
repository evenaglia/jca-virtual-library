...
import net.venaglia.realms.common.physical.geom.complex.Mesh;
import net.venaglia.realms.common.physical.geom.complex.PolyMesh;
...
import net.venaglia.realms.common.util.surfaceFn.CompositeFn;
import net.venaglia.realms.common.util.surfaceFn.NurbsFn;
import net.venaglia.realms.common.util.surfaceFn.SpiralSine;
...
//                origin.project(nowMS, buffer);
        ...
        view3D.addViewEventHandler(new ViewEventHandler() {
            public void handleInit() {
                if (polyMesh != null) {
                    meshDisplayList.record(new DisplayList.DisplayListRecorder() {
                ...
                if (normals != null) {
                    normalsDisplayList.record(new DisplayList.DisplayListRecorder() {
                        public void record(GeometryBuffer buffer) {
