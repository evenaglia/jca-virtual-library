...
//        private
        ...
        @Override
        net.venaglia.realms.common.map_x.db.impl.spatial.Entry<V> entryFor(ValueNode node, boolean highValue) {
            return new net.venaglia.realms.common.map_x.db.impl.spatial.Entry<V>(db, node, highValue);
        }
