...
import net.venaglia.gloo.physical.geom.detail.DynamicDetail;
...
//        Dimension windowSize = new Dimension(1024, 600);
        view = new View3D(windowSize.getWidth(), windowSize.getHeight()) {
            @Override
...
//                }
    ...
    public static void main(String[] args) throws Exception {
        URL myClassFile = VirtualLibrary.class.getResource(VirtualLibrary.class.getSimpleName() + ".class");
...
//        Thread.sleep(18000000);
    ...
    private static void prepareNativeLibs() throws IOException {
        String[] libFiles = {
                "libjinput-linux.so",
                ...
                "libjinput-osx.jnilib-v2.8.5",
                "liblwjgl.jnilib",
                "liblwjgl.jnilib-v2.8.5",
                "openal.dylib",
                "openal.dylib-v2.8.5",
                "OpenAL32.dll",
                "OpenAL64.dll",
        ...
        File tempDir = File.createTempFile("native-libs","");
        ...
        for (String filename : libFiles) {
            URL fileURL = classLoader.getResource("native/" + filename);
            if (fileURL != null) {
